...
(void
 (eval-source
  "(define int-state (GelStep new int-stack #f (List empty) 0 #f #f 0))"
  environment))
(void
 (eval-source
...
(void
 (eval-source
  "(define mixed-state (GelStep new mixed-stack #f (List empty) 0 #f #f 0))"
  environment))
(void
 (eval-source
...
(void
 (eval-source
  "(define point-state (GelStep new point-stack #f (List empty) 0 #f #f 0))"
  environment))
(void
 (eval-source
